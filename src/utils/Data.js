...
const coursesData = [
  {
    ...
    description:
      "Master mental arithmetic with our Abacus Techniques Mastery course.",
    benefits: [
      "Faster Calculations: Solve problems much quicker than traditional methods.",
      "Improved Concentration: Enhance focus and concentration through mental arithmetic practice.",
  ...
  },
  {
    ...
    description:
      "Refine your handwriting with our Handwriting Improvement course.",
    benefits: [
      "Enhanced Penmanship: Improve the legibility and aesthetics of your handwriting.",
      "Speed and Efficiency: Learn techniques to write faster and more efficiently.",
  ...
  },
  {
    ...
    title: "Vedic Mathematics",
    description:
      "Dive into the world of Vedic Mathematics and unlock the power of faster calculations and versatile applications.",
    benefits: [
      "Faster Calculations: Vedic Math techniques allow you to solve problems much quicker than traditional methods.",
      "Versatile Applications: Vedic Math principles can be applied to a wide range of mathematical domains.",
